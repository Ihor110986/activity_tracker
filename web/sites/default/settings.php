 ...
 * @endcode
 */
$settings['hash_salt'] = 'dhV4IYpWJ2P2x-MqtHEoH59aF2boI_y_uxZcttecZiav_jOEv7-QEqLO44n8SqVNFX45YaDn-A';
...
$settings['hash_salt'] = getenv(name: 'HASH_SALT');
$settings['config_sync_directory'] = '../config';
$settings['trusted_host_patterns'][] = getenv(name: 'PROJECT_BASE_URL');
$settings['skip_permissions_hardening'] = TRUE;
if (file_exists(filename: $app_root . '/' . $site_path . '/settings.local.php')) {
  include $app_root . '/' . $site_path . '/settings.local.php';
}